...
def bind_rgw_user_state(monkeypatch, live_client, *, test):
    ...
    monkeypatch.setattr(
        ...
        "__salt__",
        {
            ...
            "ceph_rgw_user.create_subuser": rgw_user_execution.create_subuser,
            "ceph_rgw_user.delete_subuser": rgw_user_execution.delete_subuser,
            "ceph_task.wait": waiter,
        },
        raising=False,
    )
...
def bind_rgw_bucket_state(monkeypatch, live_client, *, test):
    ...
    monkeypatch.setattr(
        ...
        "__salt__",
        {
            ...
            "ceph_rgw_bucket.get_lifecycle": rgw_bucket_execution.get_lifecycle,
            "ceph_rgw_bucket.set_lifecycle": rgw_bucket_execution.set_lifecycle,
            "ceph_task.wait": waiter,
        },
        raising=False,
    )
