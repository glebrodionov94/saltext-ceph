"""Manage current-Ceph RBD groups from the salt-ssh controller."""

import functools as _functools
import inspect as _inspect

from saltext.ceph.modules import ceph_rbd_group as _execution
from saltext.ceph.utils.ceph import rbd_group_api as _api
