"""Manage current-only Dashboard multi-cluster connections."""
...
def connect(
    ...
    """Register a remote cluster using file-based credentials.
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_multi_cluster.connect \\
          https://remote.example remote admin /run/secrets/remote-password \\
          https://hub.example ssl_verify=true \\
...
def reconnect(
    ...
    """Refresh a connection from exactly one password or token file.
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_multi_cluster.reconnect \\
          https://remote.example admin password_source=/run/secrets/remote-password \\
          ssl_verify=true \\
          ssl_certificate_source=/etc/salt/pki/remote-dashboard.pem
    """
    return _invoke(
...
def edit(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_multi_cluster.edit \\
          remote-fsid https://remote.example remote admin ssl_verify=true \\
          ssl_certificate_source=/etc/salt/pki/remote-dashboard.pem
    """
    return _invoke(
...
def delete(cluster_name, cluster_user, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_multi_cluster.delete remote-fsid admin confirm=true
    """
