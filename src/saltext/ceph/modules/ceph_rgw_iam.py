"""Manage public Ceph Dashboard RGW iam operations."""
...
def list_roles(account_id=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.list_roles
    """
...
def get_role(account_id, role_name, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.get_role account_id role_name
    """
...
def create_role(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.create_role role_name
    """
    return _invoke(
...
def update_role(role_name, max_session_duration, account_id=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.update_role role_name max_session_duration
    """
...
def delete_role(role_name, account_id=None, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.delete_role role_name
    """
...
def create_account(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.create_account account_name
    """
    return _invoke(
...
def list_accounts(daemon_name=None, detailed=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.list_accounts
    """
...
def get_account(account_id, daemon_name=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.get_account account_id
    """
...
def account_exists(account_name, daemon_name=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.account_exists account_name
    """
...
def update_account(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.update_account account_id account_name
    """
    return _invoke(
...
def delete_account(account_id, daemon_name=None, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.delete_account account_id
    """
...
def set_account_quota(account_id, quota_type, max_size, max_objects, enabled, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.set_account_quota account_id quota_type max_size max_objects enabled
    """
    return _invoke(
...
def set_account_quota_status(account_id, quota_type, quota_status, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_iam.set_account_quota_status account_id quota_type quota_status
    """
    return _invoke(
