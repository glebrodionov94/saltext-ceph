"""Manage public Ceph Dashboard RGW multisite operations."""
...
def get_sync_status(daemon_name=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_sync_status
    """
...
def get_sync_policy(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_sync_policy
    """
    return _invoke(
...
def get_sync_policy_group(group_id, bucket_name="", daemon_name="", profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_sync_policy_group group_id
    """
    return _invoke(
...
def create_sync_policy_group(group_id, status, bucket_name="", daemon_name="", profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_sync_policy_group group_id status
    """
    return _invoke(
...
def update_sync_policy_group(group_id, status, bucket_name="", daemon_name="", profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.update_sync_policy_group group_id status
    """
    return _invoke(
...
def delete_sync_policy_group(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_sync_policy_group group_id
    """
    return _invoke(
...
def create_sync_flow(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_sync_flow flow_id flow_type group_id
    """
    return _invoke(
...
def delete_sync_flow(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_sync_flow flow_id flow_type group_id
    """
    return _invoke(
...
def create_sync_pipe(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_sync_pipe group_id pipe_id source_zones destination_zones
    """
    return _invoke(
...
def delete_sync_pipe(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_sync_pipe group_id pipe_id
    """
    return _invoke(
...
def create_realm(realm_name, default=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_realm realm_name
    """
...
def get_realm(realm_name, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_realm realm_name
    """
...
def get_all_realms_info(profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_all_realms_info
    """
...
def update_realm(realm_name, new_realm_name, default=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.update_realm realm_name new_realm_name
    """
...
def get_realm_tokens(include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_realm_tokens
    """
...
def import_realm_token(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.import_realm_token realm_token_source zone_name port
    """
    return _invoke(
...
def delete_realm(realm_name, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_realm realm_name
    """
...
def create_zonegroup(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_zonegroup realm_name zonegroup_name
    """
    return _invoke(
...
def list_zonegroups(profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.list_zonegroups
    """
...
def get_zonegroup(zonegroup_name, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_zonegroup zonegroup_name
    """
...
def get_all_zonegroups_info(profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_all_zonegroups_info
    """
...
def update_zonegroup(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.update_zonegroup zonegroup_name realm_name new_zonegroup_name
    """
    return _invoke(
...
def delete_zonegroup(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_zonegroup zonegroup_name
    """
    return _invoke(
...
def get_placement_target(placement_id, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_placement_target placement_id
    """
...
def set_zonegroup_storage_classes(zone_group, placement_targets, edit=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.set_zonegroup_storage_classes zone_group placement_targets
    """
    return _invoke(
...
def delete_zonegroup_storage_class(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_zonegroup_storage_class placement_id storage_class
    """
    return _invoke(
...
def create_zone(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_zone zone_name
    """
    return _invoke(
...
def list_zones(include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.list_zones
    """
...
def get_zone(zone_name, include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_zone zone_name
    """
...
def get_all_zones_info(include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_all_zones_info
    """
...
def update_zone(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.update_zone zone_name new_zone_name zonegroup_name
    """
    return _invoke(
...
def delete_zone(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.delete_zone zone_name
    """
    return _invoke(
...
def get_pool_names(profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_pool_names
    """
...
def create_system_user(user_name, zone_name, include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.create_system_user user_name zone_name
    """
    return _invoke(
...
def get_user_list(zone_name=None, realm_name=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.get_user_list
    """
...
def set_zone_storage_class(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_multisite.set_zone_storage_class zone_name placement_target storage_class data_pool
    """
    return _invoke(
