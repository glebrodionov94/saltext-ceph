"""Query and operate Ceph's Dashboard Prometheus integration."""
...
def rules(params=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_prometheus.rules params='{"type":["alert"]}'
    """
...
def create_silence(silence, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_prometheus.create_silence \\
          silence='{"matchers":[],"startsAt":"2026-09-07T00:00:00Z","endsAt":"2026-09-07T01:00:00Z","createdBy":"automation","comment":"maintenance"}'
    """
...
def delete_silence(silence_id, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_prometheus.delete_silence 4f6a1b2c confirm=true
    """
