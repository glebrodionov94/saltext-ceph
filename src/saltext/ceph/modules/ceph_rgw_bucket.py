"""Manage public Ceph Dashboard RGW bucket operations."""
...
def list_buckets(stats=False, daemon_name=None, uid=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.list_buckets
    """
...
def get_bucket(bucket, daemon_name=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_bucket bucket
    """
...
def create_bucket(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.create_bucket bucket uid
    """
    return _invoke(
...
def update_bucket(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.update_bucket bucket bucket_id
    """
    return _invoke(
...
def delete_bucket(bucket, daemon_name=None, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.delete_bucket bucket
    """
...
def set_encryption_config(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.set_encryption_config encryption_type kms_provider config_source daemon_name
    """
    return _invoke(
...
def get_encryption(bucket_name, daemon_name=None, owner=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_encryption bucket_name
    """
...
def delete_encryption(bucket_name, daemon_name=None, owner=None, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.delete_encryption bucket_name
    """
    return _invoke(
...
def get_encryption_config(daemon_name=None, owner=None, include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_encryption_config
    """
    return _invoke(
...
def set_lifecycle(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.set_lifecycle bucket_name lifecycle
    """
    return _invoke(
...
def get_lifecycle(bucket_name, daemon_name=None, owner=None, tenant=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_lifecycle bucket_name
    """
...
def get_notifications(bucket_name, daemon_name=None, owner=None, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_notifications bucket_name
    """
...
def set_notifications(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.set_notifications bucket_name notification
    """
    return _invoke(
...
def delete_notification(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.delete_notification bucket_name notification_id
    """
    return _invoke(
...
def get_global_rate_limit(profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_global_rate_limit
    """
...
def get_rate_limit(bucket_id, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.get_rate_limit bucket_id
    """
...
def set_rate_limit(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_bucket.set_rate_limit bucket_id enabled max_read_ops max_write_ops max_read_bytes max_write_bytes
    """
    return _invoke(
