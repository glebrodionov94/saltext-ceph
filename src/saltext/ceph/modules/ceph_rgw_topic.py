"""Manage public Ceph Dashboard RGW topic operations."""
...
def create_topic(
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_topic.create_topic name
    """
    return _invoke(
...
def list_topics(include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_topic.list_topics
    """
...
def get_topic(key, include_secrets=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_topic.get_topic key
    """
...
def delete_topic(key, confirm=False, profile="default"):
    ...
    .. code-block:: bash
        ...
        salt-call --local ceph_rgw_topic.delete_topic key
    """
